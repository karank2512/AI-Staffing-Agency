...
import { ChevronDownIcon, ChevronsUpDownIcon, CheckIcon, ChevronUpIcon } from "lucide-react"
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex h-9 w-full cursor-default items-center gap-2 rounded-sm pr-8 pl-3 text-sm outline-hidden select-none focus:bg-black/5 data-disabled:pointer-events-none data-disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("pointer-events-none mx-3 my-1.5 h-px bg-border", className)}
      {...props}
    />
  )
}
